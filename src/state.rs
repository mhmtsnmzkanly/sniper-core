...
pub struct TabWorkspace {
    ...
    pub media_gallery_mode: bool,
    pub media_min_size_kb: usize,
    pub network_status_filter: String,
    pub selector_inspector_armed: bool,
...
impl TabWorkspace {
    pub fn new(_tid: String, title: String) -> Self {
        Self {
            ...
            media_sort_asc: true,
            media_gallery_mode: false,
            media_min_size_kb: 0,
            network_status_filter: "all".to_string(),
...
pub struct AppState {
    ...
    pub scripting_break_condition: String,
    pub scripting_emit_step_timing: bool,
    pub scripting_check_preflight: bool,
    pub scripting_debug_plan: Vec<String>,
    pub scripting_debug_index: usize,
    pub scripting_tab_binding: Option<String>,
    pub scripting_cancel_token: Option<Arc<AtomicBool>>,
    // IDE Features
    pub ide_autocomplete_open: bool,
    pub ide_autocomplete_suggestions: Vec<String>,
    pub ide_autocomplete_index: usize,
    pub ide_autocomplete_cursor: usize,
    pub ide_diagnostics: Vec<crate::core::scripting::types::ScriptDiagnostic>,
    pub ide_last_check_time: f64,
    pub ide_indent_size: usize,
    pub ide_search_text: String,
    pub ide_replace_text: String,
    pub ide_search_open: bool,
    // Setup wizard flags
...
impl AppState {
    pub fn new(config: AppConfig, session_ts: String) -> Self {
        Self {
            ...
            scripting_break_condition: String::new(),
            scripting_emit_step_timing: true,
            scripting_check_preflight: true,
            scripting_debug_plan: Vec::new(),
            scripting_debug_index: 0,
            scripting_tab_binding: None,
            scripting_cancel_token: None,
            ide_autocomplete_open: false,
            ide_autocomplete_suggestions: Vec::new(),
            ide_autocomplete_index: 0,
            ide_autocomplete_cursor: 0,
            ide_diagnostics: Vec::new(),
            ide_last_check_time: 0.0,
            ide_indent_size: 4,
            ide_search_text: String::new(),
            ide_replace_text: String::new(),
            ide_search_open: false,
